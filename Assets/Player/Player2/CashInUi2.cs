...
public class cashInUi2 : MonoBehaviour
{
    ...
    IEnumerator MoveAndFadeOut()
    {
        ...
        GameObject.FindGameObjectWithTag("CashIn2").transform.localScale = new Vector3(1, 1, 1);
        cashInPic.transform.position = new Vector3(-6.96f, -1.68f, 1);
