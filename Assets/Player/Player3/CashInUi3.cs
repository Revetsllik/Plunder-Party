...
public class cashInUi3 : MonoBehaviour
{
    ...
    IEnumerator MoveAndFadeOut()
    {
        ...
        GameObject.FindGameObjectWithTag("CashIn3").transform.localScale = new Vector3(1, 1, 1);
        cashInPic.transform.position = new Vector3(5.07f, 3.85f, 1);
