...
public class PickupCoin3 : MonoBehaviour
{
    public float wallet;
    public float bank;
    ...
    void Start()
    {
        ...
        cashInScript = GameObject.FindGameObjectWithTag("CashIn3").GetComponent<cashInUi3>();
    }
    ...
    void OnTriggerEnter2D(Collider2D col)
    {
        ...
        if (col.gameObject.CompareTag("Base3"))
        {
            if (wallet > 0f)
            {
                bank += wallet;
