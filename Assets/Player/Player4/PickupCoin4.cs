...
public class PickupCoin4 : MonoBehaviour
{
    public float wallet;
    public float bank;
    ...
    void Start()
    {
        ...
        cashInScript = GameObject.FindGameObjectWithTag("CashIn4").GetComponent<cashInUi4>();
    }
    ...
    void OnTriggerEnter2D(Collider2D col)
    {
        ...
        if (col.gameObject.CompareTag("Base4"))
        {
            if (wallet > 0f)
            {
                bank += wallet;
